 ...
 */
package com.hyyt.universaldialoglibrary.dialoghelper;
...
import com.hyyt.universaldialoglibrary.dialoginterface.ListDialogListener;
import com.hyyt.universaldialoglibrary.dialoginterface.OnDateTimeSetListener;
import com.hyyt.universaldialoglibrary.dialoginterface.OnNumberSetListener;
import com.hyyt.universaldialoglibrary.dialoginterface.ViewDialogListener;
import com.hyyt.universaldialoglibrary.fragmentdialog.AlertFragmentDialog;
import com.hyyt.universaldialoglibrary.fragmentdialog.NumberPickerDialog;
import com.hyyt.universaldialoglibrary.fragmentdialog.ProgressHUD;
...
public final class DialogHelper {
	...
	public static void showDialog(FragmentManager fm,String title,String message,AlertButtonsClickListener alertFrag,int type,boolean cancelable,int identifier) {
		...
		new AlertFragmentDialog.Builder(type, identifier)
		.setTitle(title)
		.setMessage(message)
	...
	public static void showDateDialog(FragmentManager fm, OnDateTimeSetListener dateListener, int identifier){
		...
		new AlertFragmentDialog.Builder(DATE_DIALOG, identifier)
		.setIs24Hour(true)
	...
	public static void showTimeDialog(FragmentManager fm,boolean is24Hour,OnDateTimeSetListener dateListener,int identifier){
		...
		new AlertFragmentDialog.Builder(TIME_DIALOG, identifier)
	...
	public static void showSimpleListDialog(FragmentManager fm,int title,ArrayList<String> list,ListDialogListener listDialogListener,int identifier,Context context){
		new AlertFragmentDialog.Builder(AlertFragmentDialog.SIMPLE_LIST_DIALOG, identifier)
	...
	public static void showSingleChoiceListDialog(FragmentManager fm, int title, ArrayList<String> list, ListDialogListener listDialogListener, int identifier, Context context){
		new AlertFragmentDialog.Builder(AlertFragmentDialog.SINGLE_CHOICE_LIST_DIALOG, identifier)
		.setTitle(context.getResources().getString(title))
		.setDialogList(list)
		.setListDialogListener(listDialogListener)
		.build(fm, "");
	...
	public static void showMultipleChoiceListDialog(FragmentManager fm,int title,ArrayList<String> list,ListDialogListener listDialogListener,int identifier,Context context){
		new AlertFragmentDialog.Builder(AlertFragmentDialog.MULTI_CHOICE_LIST_DIALOG, identifier)
		.setTitle(context.getResources().getString(title))
		.setDialogList(list)
		.setListDialogListener(listDialogListener)
		.build(fm, "");
